...
app.post('/submit-form', async (req, res) => {
  ...
  try {
    ...
    request.input('obtainedMatricMarks', sql.Int, obtainedMatricMarks);
    ...
    await request.query(`
      INSERT INTO hamzaJani (Name, Email, Course, FatherName, CNIC, Address, TotalMatricMarks, ObtainedMatricMarks, TotalInterMarks, ObtainedInterMarks, CellNo, PhoneNo)
